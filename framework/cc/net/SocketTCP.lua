...
function SocketTCP:connect(__host, __port, __retryConnectWhenFailure)
    ...
    print("call socket_connect __host, __port, __retryConnectWhenFailure = ", __host, __port, __retryConnectWhenFailure)
    if not __checkConnect() then
        ...
        local __connectTimeTick = function ()
          print("call __connectTimeTick")
            ...
            print("waitConnect:%0.2f, SOCKET_TICK_TIME:%0.2f,SOCKET_CONNECT_FAIL_TIMEOUT:%0.2f", self.waitConnect,SOCKET_TICK_TIME, SOCKET_CONNECT_FAIL_TIMEOUT)
